...
;; Keywords: local
;; Package-Requires: ((anzu "0.64") (consult "1.8") (editorconfig "0.11.0") (emacs "30.1") (form-feed "0.2.3") (mwim "0.4") (rg "2.3.0") (yasnippet "0.14.1"))
...
(setup files
  ...
  (:set
   ...
   (concat (my-data-path* "auto-save/" "lists/") "saves")
